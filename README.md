...
1. 📘 **[ARCHITECTURE.md](ARCHITECTURE.md):** Chi tiết cấu trúc kỹ thuật hệ thống, giao thức MCP Streamable HTTP và chiến lược tối ưu phần cứng Apple M5.
...
- **Hardware:** Apple M5 Series (Base, Pro, Max) với cấu hình Bộ nhớ Thống nhất (Unified Memory).
